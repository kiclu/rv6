...
add wave -noupdate -expand -group reg -radix hexadecimal /tb_hart/dut/rs1
add wave -noupdate -expand -group reg -radix hexadecimal /tb_hart/dut/rs2
add wave -noupdate -expand -group reg -radix hexadecimal /tb_hart/dut/rd
add wave -noupdate -expand -group reg -radix hexadecimal /tb_hart/dut/r1
add wave -noupdate -expand -group reg -radix hexadecimal /tb_hart/dut/r2
add wave -noupdate -expand -group reg -radix hexadecimal /tb_hart/dut/d
add wave -noupdate -expand -group reg -radix hexadecimal /tb_hart/dut/wr
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2521724 ps} 0}
...
update
WaveRestoreZoom {0 ps} {13691393 ps}
